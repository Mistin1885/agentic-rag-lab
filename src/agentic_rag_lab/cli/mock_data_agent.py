"""Command-line entrypoint for the Gemini agent demo."""
...
from agentic_rag_lab.agents.mock_data_agent import GeminiDataAgent
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run the Gemini function-calling agent demo.")
    ...
    agent = GeminiDataAgent(model=args.model, log_path=args.log_path)
